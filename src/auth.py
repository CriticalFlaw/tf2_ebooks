...
TWITTER_ARCHIVE = "ebook_tweets.csv"    # Name of the tweet archive used by the bot.
DEBUG = False	# Setting this to False will start tweeting live.
ODDS = 8	    # How often should the bot run? (8 = 1/8 times)
...
IGNORE_RETWEETS = True          # Setting this to False will have the bot ignore retweets.
USE_WEB = False			        # Setting this to True will have the bot listed websites for content.
